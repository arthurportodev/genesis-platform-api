...
- [ADR-018 — Contrato íntegro e ativação atômica da árvore de release](ADR-018-release-tree-atomic-activation.md) — Superseded pelo ADR-020; preservado para auditoria como legacy e unsupported for new deploys
...
- [ADR-020 — Deploy simples da API em VPS](ADR-020-simple-vps-deployment.md) — Accepted em 3 de setembro de 2026; define `SIMPLE_VPS_DEPLOYMENT`, pointer único, promoção/rollback API-only e supersession operacional do release-tree
