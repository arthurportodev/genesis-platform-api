...
- [ADR-019 — Valor esperado da oportunidade no ciclo comercial de Lead](ADR-019-lead-commercial-cycle-expected-value.md) — Proposed; candidato do Pipeline Experience V2 para Gate 1, sem implementação
